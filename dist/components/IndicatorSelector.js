...
export function IndicatorSelector({ chart, name }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(IconButton, { size: "small", onClick: toggleIsOpen, children: _jsx(InfoOutlined, {}) }), _jsxs(Dialog, { open: isOpen, onClose: toggleIsOpen, maxWidth: "md", fullWidth: true, children: [_jsx(DialogTitle, { children: "Indicators" }), _jsxs(DialogContent, { children: [_jsx(Box, { py: 2, children: _jsx(SearchField, { fullWidth: true, defaultValue: search, onChange: setSearch, delay: 16 }) }), INDICATORS.filter(({ label }) => label.toLowerCase().includes(search.toLowerCase())).map(({ label, ...params }) => (_jsx(MenuItem, { onClick: () => {
