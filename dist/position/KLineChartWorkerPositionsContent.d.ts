 ...
 */
export declare function KLineChartWorkerPositionsContent({ workerIdsArray, symbolId, tokenName, showPositions, }: KLineChartWorkerPositionsContentProps): import("react/jsx-runtime").JSX.Element;
export {};
