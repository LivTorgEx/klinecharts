...
export function KLineChartSettingsModal({ variant, name, onClose, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(IconButton, { onClick: handleOpen, size: "small", children: _jsx(Icon, { fontSize: "small" }) }), _jsxs(Dialog, { open: isOpen, onClose: handleClose, fullWidth: true, maxWidth: "sm", PaperProps: {
                    component: "form",
