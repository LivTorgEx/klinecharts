...
export function KLineChartLoadDebug({ backtestRunId }) {
    ...
    return (_jsxs(Box, { sx: {
            height: "128px"
        }, children: [selectedTime && (_jsx(Typography, { variant: "body2", component: "p", children: format(selectedTime, DATETIME_UI) })), timeInfo === null || timeInfo === void 0 ? void 0 : timeInfo.messages.map((msg, idx) => (_jsx(Typography, { variant: "body2", component: "p", children: msg }, idx)))] }));
}
