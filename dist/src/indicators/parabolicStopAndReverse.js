...
export class ParabolicStopAndReverse {
    constructor(start, increment, maximum) {
        this.start = start;
        this.increment = increment;
        this.maximum = maximum;
        this.isUptrend = true; // Whether the current trend is up
        this.sar = 0.0; // Current SAR value
        this.ep = 0.0; // Extreme point (highest high or lowest low)
        this.af = start; // Starting acceleration factor
        this.maxAf = maximum; // Maximum AF value
        this.afStep = increment; // Increment for AF
    }
    initializeWithCandle(input) {
    ...
    figures: [
        {
            ...
            styles: ({ data, indicator, defaultStyles }) => {
                var _a, _b, _c;
                const { current } = data;
                const sar = (_a = current === null || current === void 0 ? void 0 : current.pSAR) !== null && _a !== void 0 ? _a : Number.MIN_SAFE_INTEGER;
                const halfHL = (((_b = current === null || current === void 0 ? void 0 : current.high) !== null && _b !== void 0 ? _b : 0) + ((_c = current === null || current === void 0 ? void 0 : current.low) !== null && _c !== void 0 ? _c : 0)) / 2;
                const color = sar < halfHL
                    ? utils.formatValue(indicator.styles, "circles[0].upColor", defaultStyles.circles[0].upColor)
                    : utils.formatValue(indicator.styles, "circles[0].downColor", defaultStyles.circles[0].downColor);
                return { color };
            },
        },
    ],
