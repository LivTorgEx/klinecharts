...
export function KLineChartProgressPositions({ botId, tokenName }) {
    ...
    const existingPositionKeys = useRef(new Set());
    const existingOrderKeys = useRef(new Set());
    ...
    useEffect(() => {
        ...
        (_a = positions === null || positions === void 0 ? void 0 : positions.data) === null || _a === void 0 ? void 0 : _a.forEach((position) => {
            ...
            if (overlay) {
                if (overlay.extendData.qty !== extendData.qty ||
    ...
    useEffect(() => {
        ...
        (_a = positions === null || positions === void 0 ? void 0 : positions.data) === null || _a === void 0 ? void 0 : _a.forEach((position) => {
            position.orders.forEach((order) => {
                ...
                if (["New", "PartiallyFilled"].includes((_b = order.status) !== null && _b !== void 0 ? _b : "")) {
                    id += "_order";
                    let pnl = undefined;
                    const qtyFactor = order.qty > 0 ? 1 : -1;
                    if (order.order_type === PositionOrderType.StopMarket &&
                        order.price === 0) {
                        ...
                        const pricePrc = toMeasurePrice(position.entry_price, orderPrice) / 100;
                ...
                else if (Math.abs((_c = order.qty_filled) !== null && _c !== void 0 ? _c : 0) > 0) {
                    id += "_orderFilled";
                    if (!chart.getOverlays({ id }).length) {
                        chart.createOverlay({
                            name: "orderFilled",
