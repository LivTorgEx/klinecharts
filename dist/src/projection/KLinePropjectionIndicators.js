...
export function KLinePropjectionIndicators({ symbolId, timeframe, selectedTime, clearSelectedTime, }) {
    ...
    return (_jsxs(Stack, { children: [selectedTime && (_jsxs(Typography, { variant: "caption", children: ["Selected time: ", format(selectedTime, DATETIME_UI), " ", _jsx(IconButton, { color: "error", size: "small", onClick: clearSelectedTime, children: _jsx(Close, { fontSize: "inherit" }) })] })), indicators.map(({ name, properties }) => {
                var _a;
                return (_jsxs(Stack, { direction: "row", spacing: 2, children: [_jsx(Typography, { variant: "caption", children: name }), _jsx(Stack, { children: (_a = INDICATOR_MAP[name]) === null || _a === void 0 ? void 0 : _a.map((key) => values[key] ? (_jsxs(Stack, { direction: "row", useFlexGap: true, sx: {
                                    flexWrap: "wrap"
