...
export declare const WebsocketEventName: {
...
export type ClientWebSocketConnection = {
    ...
    isConnected: boolean;
    subscribe: <T extends WebsocketTradeEvent | WebsocketProjectionEvent>(event: WebsocketEventName, handler: (data: T) => void) => void;
    sendSubscribe: (data: {
        event: string;
        symbol: string;
    }) => void;
    unsubscribe: <T extends WebsocketTradeEvent | WebsocketProjectionEvent>(event: WebsocketEventName, handler: (data: T) => void) => void;
